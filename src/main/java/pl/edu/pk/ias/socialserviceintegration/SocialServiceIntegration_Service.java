 ...
 * 
 */
@WebServiceClient( name = "SocialServiceIntegration",
                   targetNamespace = "http://pk.edu.pl/ias/socialserviceintegration",
                   wsdlLocation = "http://twitpic.piotrkubowicz.pl/soap?wsdl" )
public class SocialServiceIntegration_Service extends Service
{

    private static URL SOCIALSERVICEINTEGRATION_WSDL_LOCATION;
    private static WebServiceException SOCIALSERVICEINTEGRATION_EXCEPTION;
    private final static QName SOCIALSERVICEINTEGRATION_QNAME = new QName("http://pk.edu.pl/ias/socialserviceintegration",
                                                                          "SocialServiceIntegration");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://twitpic.piotrkubowicz.pl/soap");
        }
    ...
    public SocialServiceIntegration_Service( String urlPath ) {
    ...
    public SocialServiceIntegration getSocialServiceIntegrationEndpoint( ) {
        return super.getPort(new QName("http://pk.edu.pl/ias/socialserviceintegration",
                                       "SocialServiceIntegrationEndpoint"), SocialServiceIntegration.class);
    }
    ...
    public SocialServiceIntegration getSocialServiceIntegrationEndpoint( WebServiceFeature... features ) {
        return super.getPort(new QName("http://pk.edu.pl/ias/socialserviceintegration",
                                       "SocialServiceIntegrationEndpoint"),
