        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        */
                                    ...
                                    protected pl.edu.pk.ias.types.Item[] localItemsList ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           * @return pl.edu.pk.ias.types.Item[]
                           */
                           public  pl.edu.pk.ias.types.Item[] getItemsList(){
                               ...
                               */
                              protected void validateItemsList(pl.edu.pk.ias.types.Item[] param){
                              ...
                              */
                              public void setItemsList(pl.edu.pk.ias.types.Item[] param){
                             ...
                             * @param param pl.edu.pk.ias.types.Item
                             */
                             public void addItemsList(pl.edu.pk.ias.types.Item param){
                                   if (localItemsList == null){
                                   localItemsList = new pl.edu.pk.ias.types.Item[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localItemsList);
                               list.add(param);
                               this.localItemsList =
                             (pl.edu.pk.ias.types.Item[])list.toArray(
                            new pl.edu.pk.ias.types.Item[list.size()]);
                                       ...
                                       if (localItemsList!=null){
                                            for (int i = 0;i < localItemsList.length;i++){
                                                if (localItemsList[i] != null){
                                                 localItemsList[i].serialize(new javax.xml.namespace.QName("http://pk.edu.pl/ias/types","itemsList"),
                                                           xmlWriter);
                                                } else {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getItemsResponse".equals(type)){
                                ...
                                return (GetItemsResponse)pl.edu.pk.ias.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://pk.edu.pl/ias/types","itemsList").equals(reader.getName())){
                                
                                    
                                    
                                    // Process the array and step past its final element's end.
                                    list1.add(pl.edu.pk.ias.types.Item.Factory.parse(reader));
                                                        ...
                                                        object.setItemsList((pl.edu.pk.ias.types.Item[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                pl.edu.pk.ias.types.Item.class,
                                                                list1));
