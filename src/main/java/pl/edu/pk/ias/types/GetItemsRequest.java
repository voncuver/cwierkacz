        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        */
                                    ...
                                    protected pl.edu.pk.ias.types.ItemId[] localIdsList ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           ...
                           /**
                           * Auto generated getter method
                           * @return pl.edu.pk.ias.types.ItemId[]
                           */
                           public  pl.edu.pk.ias.types.ItemId[] getIdsList(){
                               return localIdsList;
                           }
                               ...
                               */
                              protected void validateIdsList(pl.edu.pk.ias.types.ItemId[] param){
                              ...
                              * @param param IdsList
                              */
                              public void setIdsList(pl.edu.pk.ias.types.ItemId[] param){
                             ...
                             * @param param pl.edu.pk.ias.types.ItemId
                             */
                             public void addIdsList(pl.edu.pk.ias.types.ItemId param){
                                   if (localIdsList == null){
                                   localIdsList = new pl.edu.pk.ias.types.ItemId[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localIdsList);
                               list.add(param);
                               this.localIdsList =
                             (pl.edu.pk.ias.types.ItemId[])list.toArray(
                            new pl.edu.pk.ias.types.ItemId[list.size()]);
                                       ...
                                       if (localIdsList!=null){
                                            for (int i = 0;i < localIdsList.length;i++){
                                                if (localIdsList[i] != null){
                                                 localIdsList[i].serialize(new javax.xml.namespace.QName("http://pk.edu.pl/ias/types","idsList"),
                                                           xmlWriter);
                                                } else {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getItemsRequest".equals(type)){
                                ...
                                return (GetItemsRequest)pl.edu.pk.ias.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list2 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://pk.edu.pl/ias/types","idsList").equals(reader.getName())){
                                
                                    
                                    
                                    // Process the array and step past its final element's end.
                                    list2.add(pl.edu.pk.ias.types.ItemId.Factory.parse(reader));
                                                        ...
                                                        object.setIdsList((pl.edu.pk.ias.types.ItemId[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                pl.edu.pk.ias.types.ItemId.class,
                                                                list2));
