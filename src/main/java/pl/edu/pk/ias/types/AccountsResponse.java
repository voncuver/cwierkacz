                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  pl.edu.pk.ias.types.Lss[] getLss(){
                               ...
                               */
                              protected void validateLss(pl.edu.pk.ias.types.Lss[] param){
                             ...
                             * @param param pl.edu.pk.ias.types.Lss
                             */
                             public void addLss(pl.edu.pk.ias.types.Lss param){
                                   if (localLss == null){
                                   localLss = new pl.edu.pk.ias.types.Lss[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localLss);
                               list.add(param);
                               this.localLss =
                             (pl.edu.pk.ias.types.Lss[])list.toArray(
                            new pl.edu.pk.ias.types.Lss[list.size()]);
                ...
                if (localLssTracker){
                                       if (localLss!=null){
                                            for (int i = 0;i < localLss.length;i++){
                                                if (localLss[i] != null){
                                                 localLss[i].serialize(new javax.xml.namespace.QName("http://pk.edu.pl/ias/types","lss"),
                                                           xmlWriter);
                                                } else {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"accountsResponse".equals(type)){
                                ...
                                return (AccountsResponse)pl.edu.pk.ias.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    list1.add(pl.edu.pk.ias.types.Lss.Factory.parse(reader));
                                                        ...
                                                        object.setLss((pl.edu.pk.ias.types.Lss[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                pl.edu.pk.ias.types.Lss.class,
                                                                list1));
